...
MODULOS=  $(EJECUTABLE).o entradaTeclado.o visual.o mouse.o modelo.o  file_ply_stl.o  cubo.o npyramid.o pyramid.o revolutionfigure.o figure.o calculaNormal.o estructura.o
